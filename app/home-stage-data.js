export const stageGroups = [
  {
    ...
    relatedHeading: "Related tools and ideas",
    links: [
      {
      ...
      },
      {
        ...
        title: "Coast FIRE",
        description:
          "A simple explanation of Coast FIRE, who it fits, and the trade-offs behind it.",
      },
      {
  ...
  },
  {
    ...
    description:
      "Simplify life, reduce pressure, and understand what still drives you.",
    relatedHeading: "Related reflections and paths",
    links: [
      {
  ...
  },
  {
    ...
    description:
      "Move from achievement toward reflection, contribution, and inward growth.",
    relatedHeading: "Related directions to explore",
    links: [
      {
        href: "/start-here",
        title: "Start Here",
